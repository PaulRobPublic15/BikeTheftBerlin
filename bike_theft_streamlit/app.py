...
from apps import data_sources, home, data_stats # import your app modules here
from apps import app_tweets, bike_accident1, bike_accident2, bike_sharing1, bike_sharing2, bike_theft1, bike_theft2, under_the_hood
...
app.add_app("Bike Tweets", app_tweets.app)
app.add_app("Data sources", data_sources.app)
