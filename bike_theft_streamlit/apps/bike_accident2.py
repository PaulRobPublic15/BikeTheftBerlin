...
def app():
    st.title('Bike accident cluster analysis.')
    st.write("Five of more accidents that occured within 25m of each other")
    ...
    st.write("Bike lane info from [InfraVelo](https://www.infravelo.de/)")
    st.write("Red, intended - Green, completed - Orange, in planning ")
